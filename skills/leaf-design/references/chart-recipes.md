...
Downstream of `system/DESIGN.md` § Data visualization (leafgrowio/brand, v2.0.2). All colours by token — the kit's `leaf-tokens.css` defines every variable used here.
