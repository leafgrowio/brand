...
1. **`DESIGN.md`** (in this folder) — the ratified written spec (v2.1.1). Every rule and token traces to it. This is the single canonical DESIGN.md; there is deliberately no copy at the repo root.
