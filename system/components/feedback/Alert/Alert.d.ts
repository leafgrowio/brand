 ...
 * 1px tinted border, a solid state-colour round badge, and Ink message
 * text. Coral never appears in an alert.
 */
export interface AlertProps {
  /** State — drives the tint fill, border, and badge colour/glyph. */
